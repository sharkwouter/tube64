...
u8 Palette[256*3];         //�������� ������� VGA 6:6:6
u16 PAL16[256];            //������������� ������� � 16-������ ����� RGB 5:6:5

u16 VRAMBuffer[320*200]; //���������� ��� SDL2

static SDL_Renderer *renderer=NULL;
static SDL_Window   *window  =NULL;
static SDL_Texture  *texture =NULL;

void ToScreen(void) //�������� ����������� ���� � ���������� SDL2 � ���������� ������� � ��������� � ����
{
...
void ReadConfig(void) //��������� ������������ �� �����. ���� ����� ���, �� ��������� ������������
{
 ...
 char nanobuf[64];
 int tmp;         //���� ������������� ������������ ������ int. ������ ��� fscanf() � short(%hx) � char(%hhx) ����� ���� ����������� � ������� �������������!
...
int CPP_high_tube(void) //FINAL �������������� �������. ������������� ����� signed ���, ��� ����. ����� ��������� �������� ������ ��� all chars signed � ���������� �����������.
{
  signed char *v0; // eax
  signed char *v1; // eax
  signed char *v2; // eax
...
int CPP_DrawASpriteMCGA(i16 a1, i16 a2, int a3) //FINAL
{
  ...
  CPP_DrawSpriteVres256(DX /*dx*/ , a2 /*ecx*/, a1 /*ebx*/, (char*)(SP<char>)(i32)(*(UA<i32> *)(i32*)(SP<i32>)a3) /*esi*/ , 0, 0); //������� �������� ���������� �������!
...
*/
    ...
    if ( level_no != 3 )
    {
      CPP_DrawBoxBPP(160 * i, 20, 3 * (*(UA<i32> *)((char *) dword_256784 + 30 * i) >> 16), 2, 15, 1); //������ ������� ��� ����� ������
...
int CPP_new_starfield(i16 a1, int a2) //FINAL
{
  ...
  while ( v8 )
  {
    v6 = ((signed)(sintable[v9] * sts[2 * v7]) >> 10) / (v5 + 57) + scroll_x; //����� signed! ����� ����� �������� ������ � ������ ������� �������� ������!

    if ( (v6 >= 0) && (v6 < vec_window_width) )
    {
      v4 = scroll_y - ((signed)(costable[v9] * sts[2 * v7 + 1]) >> 10) / (v5 + 57); //���� signed
...
//  unsigned int v1;
  ...
  int result; // eax
  signed char v3; // [esp+4h] [ebp-2Ch]         ������� signed
...
//          a1 = 1024;
        ...
        case 7:
          ...
          *((u16 *)v78 + 2) += -256 * vx[i];
          ...
          if ( v77 >= 0x7800u )
          {
            if ( v77 < 0x8000 ) //if ( v77 - 0x8000 > v77 ) ��������� ����������
              HIWORD(v76) = 1;
          }
          else if ( v77 >= 0x8000 ) //if ( v77 + 0x8000 < v77 ) ��������� ����������
          {
            v76 = v77 - 0x10000;
          }
...
int CPP_quick_sort_ships(int a1, i16 a2) //FINAL
{
  ...
  if ( (i16)a1 < a2 )
  {
    ...
    for ( i = a1 + 1; i <= a2; ++i )
    {
    //if ( *(UA<u16> *)(draw_items[i] + 6) > *(UA<u16> *)(draw_items[(i16)a1] + 6) ) //��� �������� ������� �������� � �������
...
int CPP_do_players_ships(void) //�������������� ���������, �� ������ ��������� ������������ �����������: dword_25678D � dword_256791.
{
  int result; // eax
  unsigned int *v3; // ebx
  int v4; // eax
...
//  i64 v39; // [esp-1Ch] [ebp-50h]
  ...
  /*int*/ char  v54; // [esp+1Ch] [ebp-18h]  //����� �������� ���� ���������� �����������, ���� ��� ���� char. ��������, ���� ����� ������?
...
int CPP_tunnel_table(void) //FINAL
{
  ...
  for ( i = 0; i < 256 ; ++i )
  {
    ...
    CPP_trig((int*)&V[4],(int*)&V[2],(int*)&V[0]); //������ �����������: 3 ������� - X,Y ���������� �������(���������?)
  }
...
{
//  CPP_FadePalette256(0, 0x10u, 0); //������� DOS'������ ������� - ����� ��� �� �����
...
int CPP_LoadData(char *a3) //FINAL
{
  ...
  else
  {
    ...
    **(SP<u32>)(a3 + 28) = v6;
    ...
    {
      **(SP<u32>)(a3 + 28) = (void*)0; //���������� 0
      **(SP<u32>)(a3 + 32) = (void*)0; //���������� 0
      *(UA<u32> *)(a3 + 36) = 0;
      return 0;
    }
